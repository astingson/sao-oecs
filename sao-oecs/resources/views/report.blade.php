...
<meta charset="UTF-8">
    ...
    <div class="container w-full mx-auto">
        ...
        <div class="w-full px-4 md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">Total Budget</h5>
                                <h3 class="font-bold text-3xl">PHP 30 249 <span class="text-green-500"><i class="fas fa-caret-up"></i></span></h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">Average Time of Approval</h5>
                                <h3 class="font-bold text-3xl">2 days</h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">Approved Events</h5>
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-white border rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-500">Denied Events</h5>
            ...
            <!--Divider-->
            <!-- <hr class="border-b-2 border-white my-4 mx-2"> -->
            ...
            <div class="flex flex-row flex-wrap flex-grow mt-2">
                ...
                <div class="overflow-hidden relative w-64 mt-4 mb-4">
                    <button class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center" disabled>

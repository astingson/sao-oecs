        ...
        <form action="{{ route('forms.update', $form->id) }}" method="post">
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    type="text" value="{{  $form->activity_title  }}" placeholder="Event Title">
                ...
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    rounded py-3 px-4 @error('venue') border-red-500 @enderror"
                    type="text" value="{{ $form->venue }}" placeholder="e.g. Room 212 / MPH 1 / MS Teams">
                    @error('venue')
                    <div class="text-red-500 mt-2 text-sm">
                    {{ $message }}
                    </div>
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                    ...
                    type="date" value="{{ $form->target_date }}" placeholder="">
                    @error('target_date')
                    <div class="text-red-500 mt-2 text-sm">
                    {{ $message }}
                    </div>
                ...
                <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3 @error('start_date') border-red-500 @enderror"
                    type="date" value="{{ $form->start_date }}" placeholder="">
                ...
                <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3 @error('end_date') border-red-500 @enderror"
                    type="date" value="{{ $form->end_date }}" placeholder="">
                ...
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative mb-6 md:mb-0">
                        ...
                        border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded @error('org_id') border-red-500 @enderror">
                            <option value="{{  $form->org->id  }}" label="{{  $form->org->org_name  }}" style="display:none" selected></option>
                ...
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative mb-6 md:mb-0">
                        ...
                        border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded @error('coorganization') border-red-500 @enderror">
                            <option value="{{  $form->coorganization  }}" label="{{  $form->coorganization  }}" style="display:none" selected value></option>
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 @error('organizer_name') border-red-500 @enderror"
                    type="text" value="{{ $form->organizer_name }}" placeholder="First name Last name">
                </div>
                ...
                <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 @error('organizer_contact') border-red-500 @enderror"
                    type="text" value="{{ $form->organizer_contact }}" placeholder="09123456789">
                </div>
                ...
                <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 @error('organizer_email') border-red-500 @enderror"
                    type="text" value="{{ $form->organizer_email }}" placeholder="abc@domain.com">
                </div>
            </div>
            ...
            <div id="coorganization_info" class="hidden">
                <div class="-mx-3 md:flex mb-6">
                    <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                        ...
                        text-grey-darker border border-grey-lighter rounded py-3 px-4" type="text" value="{{ $form->coorganizer_name }}" placeholder="First name Last name">
                    </div>
                    ...
                    <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                        ...
                        text-grey-darker border border-grey-lighter rounded py-3 px-4" type="text" value="{{ $form->coorganizer_contact }}" placeholder="09123456789">
                    </div>
                    ...
                    <div class="md:w-4/12 px-3 mb-6 md:mb-0">
                        ...
                        text-grey-darker border border-grey-lighter rounded py-3 px-4" type="text" value="{{ $form->coorganizer_email }}" placeholder="abc@domain.com">
                    </div>
                </div>
            </div>
                    ...
                    <label class="block uppercase tracking-wide text-grey-darker text-xs font-bold mb-2" for="activity-classification">
                        ...
                        <div class="relative mb-6 md:mb-0">
                            ...
                            border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded @error('activity_classification') border-red-500 @enderror">
                                <option value="{{  $form->activity_classification  }}" label="{{  $form->activity_classification }}" style="display:none" selected></option>
                ...
                <div class="md:w-8/12 px-3 mb-6 md:mb-0">
                    ...
                    <div class="relative mb-6 md:mb-0">
                        ...
                        border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded @error('activity_classification2') border-red-500 @enderror" id="activity-classification2">
                            <option value="{{  $form->activity_classification2  }}" label="{{  $form->activity_classification2  }}" style="display:none" selected></option>
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-full px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 resize-y @error('description') border-red-500 @enderror" value="{{ $form->description }}">{{ $form->description }}</textarea>
                </div>
            </div>
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-full px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 resize-y @error('rationale') border-red-500 @enderror" value="{{ $form->rationale }}">{{ $form->rationale }}</textarea>
                </div>
            </div>
            ...
            <div class="-mx-3 md:flex">
                <div class="md:w-full px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 resize-y @error('outcome') border-red-500 @enderror" value="{{ $form->outcome }}">{{ $form->outcome }}</textarea>
                </div>
            </div>
            ...
            <div class="-mx-3 md:flex mb-6 mt-6">
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 @error('primary_beneficiary') border-red-500 @enderror"
                    type="text" value="{{ $form->primary_beneficiary }}" placeholder="e.g. Students">
                </div>
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 @error('num_primary_beneficiary') border-red-500 @enderror"
                    type="number" value="{{ $form->num_primary_beneficiary }}" placeholder="">
                </div>
            </div>
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    type="text" value="{{ $form->secondary_beneficiary }}" placeholder="">
                </div>
                <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4"
                    type="number" value="{{ $form->num_secondary_beneficiary }}" placeholder="">
                </div>
            </div>
            ...
            <div class="-mx-3 md:flex mb-6">
                <div class="md:w-full px-3 mb-6 md:mb-0">
                    ...
                    text-grey-darker border border-grey-lighter rounded py-3 px-4 resize-y @error('activities') border-red-500 @enderror" value="{{ $form->activities }}">{{ $form->activities }}</textarea>
            ...
            <div id="budgetForm">
                <div class="-mx-3 md:flex mb-6">
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3 @error('date_needed') border-red-500 @enderror"
                        type="date" value="{{ $form->date_needed }}" placeholder="">
                    ...
                    <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative mb-6 md:mb-0">
                            ...
                            border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded @error('requi_type') border-red-500 @enderror">
                                <option value="{{  $form->requi_type  }}" label="{{  $form->requi_type  }}" style="display:none" selected></option>
                    ...
                    <div class="align-middle inline-block min-w-full shadow-sm overflow-hidden sm:rounded-lg border border-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="flex items-center">
                                        <input name="moreFields[{{  $loop->index  }}][item_quantity]" class="item_quantity appearance-none block w-full bg-gray-100 text-grey-darker border border-grey-lighter 
                                        rounded py-3 px-4" value="{{  $item_detail->item_quantity  }}"type="number">
                                    </div>
                                </td>

                                <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="flex items-center">
                                        <input name="moreFields[{{  $loop->index  }}][item_purpose]" class="item_purpose appearance-none block w-full bg-gray-100 text-grey-darker border border-grey-lighter 
                                        rounded py-3 px-4" value="{{  $item_detail->item_purpose  }}" type="text">
                                    </div>
                                </td>

                                <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="flex items-center">
                                        <input name="moreFields[{{  $loop->index  }}][item_cost]" class="item_cost appearance-none block w-full bg-gray-100 text-grey-darker border border-grey-lighter 
                                        rounded py-3 px-4" value="{{  $item_detail->item_cost  }}" type="number">
                                    </div>
                                </td>
                            </tr>
                            @if($loop->last)
                            <input type="text" value="{{ $loop->count }}" class="hidden" id="lastIndex"/>
                            @endif
                        ...
                        <div class="-mx-3 pl-2 float-right md:flex">
                            <div class="md:w-full m-2 mr-5 md:mb-0">
                                ...
                                type="text" value="{{ $form->total_cost }}" placeholder="Total Cost (PHP)" readonly>
                            </div>
                        </div>
                ...
                <div class="-mx-3 md:flex m-6">
                    <div class="md:w-full px-3 mb-6 md:mb-0">
                        ...
                        text-grey-darker border border-grey-lighter rounded py-3 px-4 resize-y @error('remarks') border-red-500 @enderror" value="{{ $form->remarks }}">{{$form->remarks}}</textarea>
                ...
                <div class="-mx-3 md:flex m-6">
                    <div class="md:w-full px-3 mb-6 md:mb-0">
                        ...
                        text-grey-darker border border-grey-lighter rounded py-3 px-4 resize-y @error('charged') border-red-500 @enderror" value="{{ $form->charged }}" placeholder="Department/Unit">{{$form->charged}}</textarea>
